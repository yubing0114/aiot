...
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.EM_EVENT_IVS_TYPE;
...
public class DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO extends NetSDKLib.SdkStructure {
     ...
     * 检测区域
     */
    public NetSDKLib.DH_POINT[] stuDetectRegion = (NetSDKLib.DH_POINT[]) new NetSDKLib.DH_POINT().toArray(SDKStructureFieldLenth.DH_MAX_DETECT_REGION_NUM);
    /**
     * 检测到的物体个数
     */
     ...
     * 检测到的物体
     */
    public NetSDKLib.DH_MSG_OBJECT[] stuObjects = (NetSDKLib.DH_MSG_OBJECT[]) new NetSDKLib.DH_MSG_OBJECT().toArray(SDKStructureFieldLenth.HDBJ_MAX_OBJECTS_NUM);
    /**
     * 事件触发的预置点号，从1开始
     */
