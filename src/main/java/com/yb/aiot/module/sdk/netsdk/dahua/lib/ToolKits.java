...
import com.yb.aiot.module.sdk.netsdk.dahua.common.ErrorCode;
...
//	}
    ...
    public static String getErrorCodeShow() {
        return ErrorCode.getErrorCode(DhModule.netsdk.CLIENT_GetLastError());
    }
    ...
    public static String getErrorCodePrint() {
        return "\n{error code: (0x80000000|" + (DhModule.netsdk.CLIENT_GetLastError() & 0x7fffffff) + ").参考  NetSDKLib.java }"
                + " - {error info:" + ErrorCode.getErrorCode(DhModule.netsdk.CLIENT_GetLastError()) + "}\n";
    }
