...
public class CFG_HIGH_TOSS_DETECT_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 相应物体类型列表 */
  public byte[] szObjectTypes = new byte[SDKStructureFieldLenth.MAX_OBJECT_LIST_SIZE * NetSDKLib.MAX_NAME_LEN];
  /** 云台预置点编号 0~65535 */
  ...
  public NetSDKLib.CFG_TIME_SECTION[] stuTimeSection =
      (NetSDKLib.CFG_TIME_SECTION[])
          new NetSDKLib.CFG_TIME_SECTION().toArray(SDKStructureFieldLenth.WEEK_DAY_NUM * SDKStructureFieldLenth.MAX_REC_TSECT_EX);
  /** 检测区顶点数 */
