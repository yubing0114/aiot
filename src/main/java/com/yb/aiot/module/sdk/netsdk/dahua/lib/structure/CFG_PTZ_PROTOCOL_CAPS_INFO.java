...
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.EM_SUPPORT_FOCUS_MODE;
...
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLib.SdkStructure {
     ...
     * 操作的协议名
     */
    public byte[] szName = new byte[SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN];
    /**
     * 云台辅助功能名称列表
     */
