...
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.NET_EM_MASK_TYPE;
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.NET_EM_MOSAIC_TYPE;
...
public class CFG_PTZ_PRIVACY_MASKING extends NetSDKLib.SdkStructure {
     ...
     */
    public int[] emMaskType = new int[SDKStructureFieldLenth.MAX_MASKTYPE_COUNT];
    /**
     * 是否支持马赛克遮挡块设置
     */
     ...
     */
    public int[] emMosaicType = new int[SDKStructureFieldLenth.MAX_MOSAICTYPE_COUNT];
}
