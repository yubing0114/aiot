...
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.NET_EM_CFG_OPERATE_TYPE;
...
public class NET_CFG_VSP_GAYS_SERVER_INFO extends NetSDKLib.SdkStructure {
     ...
     * SIP服务器信息
     */
    public NET_SIP_SERVER_INFO[] stuSipServerInfo = new NET_SIP_SERVER_INFO[SDKStructureFieldLenth.MAX_SIP_SERVER_NUM];
    /**
     * 获取到的实际返回SIP服务器信息个数
     */
