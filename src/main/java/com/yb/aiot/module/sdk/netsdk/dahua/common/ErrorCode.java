package com.yb.aiot.module.sdk.netsdk.dahua.common;

import com.yb.aiot.module.sdk.netsdk.dahua.lib.LastError;
...
public class ErrorCode {
	...
	/**
	 * 登录设备设备错误状态中英文
	 * @param err 接口CLIENT_GetLastError返回, error code: (0x80000000|" + (DhModule.netsdk.CLIENT_GetLastError() & 0x7fffffff) +")
	 * @return
	 */
