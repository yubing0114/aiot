...
import com.yb.aiot.module.sdk.netsdk.dahua.lib.enumeration.EM_SERVER_OPTION;
...
public class NET_SIP_SERVER_INFO extends NetSDKLib.SdkStructure {
     ...
     * SIP服务器编号
     */
    public byte[] szSipSvrId = new byte[SDKStructureFieldLenth.MAX_SIP_SVR_ID_LEN];
    /**
     * SIP域
     */
    public byte[] szDomain = new byte[SDKStructureFieldLenth.MAX_SIP_DOMAIN_LEN];
    /**
     * SIP服务器 IP
     */
    public byte[] szSipSvrIp = new byte[SDKStructureFieldLenth.MAX_SIP_SVR_IP_LEN];
    /**
     * 设备编号
     */
    public byte[] szDeviceId = new byte[SDKStructureFieldLenth.MAX_SIP_SERVER_DEVICE_ID_LEN];
    /**
     * 注册密码
     */
    public byte[] szPassword = new byte[SDKStructureFieldLenth.MAX_REG_PASSWORD_LEN];
    /**
     * 本地SIP服务端口
     */
     ...
     * 行政区划代码
     */
    public byte[] szCivilCode = new byte[SDKStructureFieldLenth.MAX_CIVIL_CODE_LEN];
    /**
     * 接入模块识别码
     */
    public byte[] szIntervideoID = new byte[SDKStructureFieldLenth.MAX_INTERVIDEO_ID_LEN];
    /**
